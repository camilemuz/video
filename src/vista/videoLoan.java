...
public class videoLoan extends JFrame {
	...
	public videoLoan() {
		...
		btnVideoLoan.setForeground(new Color(255, 255, 255));
		...
		btnVideoLoan.setBackground(new Color(51, 51, 51));
		...
		JPanel panel_videoLoan = new JPanel();
		panel_videoLoan.setLayout(null);
		panel_videoLoan.setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(255, 255, 255), new Color(255, 255, 255), new Color(255, 255, 255), new Color(255, 255, 255)));
		panel_videoLoan.setBackground(new Color(255, 153, 51));
		panel_videoLoan.setBounds(304, 130, 806, 517);
		contentPane.add(panel_videoLoan);
		
		JLabel lblVideoLoan = new JLabel("VIDEO LOAN");
		lblVideoLoan.setForeground(Color.WHITE);
		lblVideoLoan.setFont(new Font("Lucida Sans Unicode", Font.BOLD | Font.ITALIC, 32));
		lblVideoLoan.setBounds(38, 27, 235, 26);
		panel_videoLoan.add(lblVideoLoan);
		
		JButton btnAddVideoLoan = new JButton("Add  Video Loan");
		btnAddVideoLoan.setForeground(new Color(0, 102, 102));
		btnAddVideoLoan.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 20));
		btnAddVideoLoan.setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(255, 255, 255), new Color(255, 255, 255), new Color(255, 255, 255), new Color(255, 255, 255)));
		btnAddVideoLoan.setBackground(new Color(204, 204, 204));
		btnAddVideoLoan.setBounds(10, 65, 184, 36);
		panel_videoLoan.add(btnAddVideoLoan);
		...
		panel_videoLoan.add(label_1);
		
		txtBuscar = new JTextField();
		txtBuscar.setColumns(10);
		txtBuscar.setBounds(414, 27, 382, 30);
		panel_videoLoan.add(txtBuscar);
